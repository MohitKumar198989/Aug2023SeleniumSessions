...
//		doSendKeys(pwd, "test@123"); 
		...
		//6th: By locator + generic methods for element and action in the other element util class 
//		By eId = By.id("input-email");
//		By pwd = By.id("input-password");
//		
