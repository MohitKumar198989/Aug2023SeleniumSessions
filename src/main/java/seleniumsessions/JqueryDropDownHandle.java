...
//		Thread.sleep(2000);
//		List<WebElement> optionsList = driver.findElements(By.cssSelector("ul#files-menu div"));

		driver.findElement(By.cssSelector("span#number-button")).click();
		Thread.sleep(2000);
		List<WebElement> optionsList = driver.findElements(By.cssSelector("ul#number-menu div"));
